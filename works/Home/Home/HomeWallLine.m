...
#import "HomeWallLine.h"

@interface HomeWallLine(){
    float mWallHeight;
    HomeWallPoint *mWallPoint1;
    HomeWallPoint *mWallPoint2;
    float mLineA;
    float mLineB;
    float mLineC;
    NSMutableArray<HomeArchItem*> *mWallComponentArr;
}

@end

@implementation HomeWallLine
...
- (void)updateComponentPercentOfWallLine{
    ...
    for (HomeArchItem *wallComponent in mWallComponentArr) {
