...
double Fun(double x);
void myMain(char * argv);
/// Dude hole examples
vector<p2t::Point*> CreateHeadHole();
vector<p2t::Point*> CreateChestHole();
GLFWwindow *window;
float rotate_y = 0,
rotate_z = 0;
...
//        return 1;
//    }
    char *argv[5] = {"p2t","random","10","100","5.0"};
    ...
    if(s.find("dude.dat", 0) != string::npos) {
        // Add head hole
        vector<p2t::Point*> head_hole = CreateHeadHole();
        num_points += head_hole.size();
        cdt->AddHole(head_hole);
        // Add chest hole
        vector<p2t::Point*> chest_hole = CreateChestHole();
...
void Init()
{
    ...
    window = glfwCreateWindow(600, 600, "Poly2Tri - C++", NULL, NULL);
    //    if (glfwOpenWindow(window_width, window_width, 5, 6, 5, 0, 0, 0, GLFW_WINDOW) != GL_TRUE)
    //        ShutDown(1);
...
vector<p2t::Point*> CreateHeadHole() {
    ...
    head_hole.push_back(new p2t::Point(325, 437));
    head_hole.push_back(new p2t::Point(320, 423));
    head_hole.push_back(new p2t::Point(329, 413));
    head_hole.push_back(new p2t::Point(332, 423));
...
vector<p2t::Point*> CreateChestHole() {
    ...
    chest_hole.push_back(new p2t::Point(320.72342,480));
    chest_hole.push_back(new p2t::Point(338.90617,465.96863));
    chest_hole.push_back(new p2t::Point(347.99754,480.61584));
    chest_hole.push_back(new p2t::Point(329.8148,510.41534));
    chest_hole.push_back(new p2t::Point(339.91632,480.11077));
    chest_hole.push_back(new p2t::Point(334.86556,478.09046));
